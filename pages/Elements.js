				...
				<section>
					...
					<div className="box alt">
						<div className="row gtr-50 gtr-uniform">
							<div className="col-12"><span className="image fit"><Image src={'/assets/images/banner.jpg'} layout='fill' alt="" /></span></div>
							<div className="col-4"><span className="image fit"><Image src={'/assets/images/pic01.jpg'} layout='fill' alt="" /></span></div>
							<div className="col-4"><span className="image fit"><Image src={'/assets/images/pic02.jpg'} layout='fill' alt="" /></span></div>
							<div className="col-4"><span className="image fit"><Image src={'/assets/images/pic03.jpg'} layout='fill' alt="" /></span></div>
							<div className="col-4"><span className="image fit"><Image src={'/assets/images/pic03.jpg'} layout='fill' alt="" /></span></div>
							<div className="col-4"><span className="image fit"><Image src={'/assets/images/pic02.jpg'} layout='fill' alt="" /></span></div>
							<div className="col-4"><span className="image fit"><Image src={'/assets/images/pic01.jpg'} layout='fill' alt="" /></span></div>
							<div className="col-4"><span className="image fit"><Image src={'/assets/images/pic02.jpg'} layout='fill' alt="" /></span></div>
